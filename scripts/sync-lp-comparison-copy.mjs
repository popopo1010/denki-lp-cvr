...
const REPLACEMENTS = [
  [
    ...
    "次の画面：<strong>求人の概要</strong>を先にお見せします（全文は登録後にお届け · あと3ステップ）"
  ],
  [
    "次に届く求人：<strong>1級・2級・工種別</strong>（建築／土木／電気施工管理）のマッチリスト（あと3ステップ）",
    "次の画面：施工管理向けの<strong>求人概要</strong>を先にお見せします（全文は登録後にお届け · あと3ステップ）"
  ],
  [
    "次に届く求人：<strong>建築施工管理の1級・2級</strong>に特化したマッチリスト（あと3ステップ）",
    "次の画面：建築施工管理向けの<strong>求人概要</strong>を先にお見せします（全文は登録後にお届け · あと3ステップ）"
  ],
  [
    "次に届く求人：<strong>土木施工管理の1級・2級</strong>に特化したマッチリスト（あと3ステップ）",
    "次の画面：土木施工管理向けの<strong>求人概要</strong>を先にお見せします（全文は登録後にお届け · あと3ステップ）"
  ],
  [
    "次に届く求人：<strong>電気工事施工管理の1級・2級</strong>に特化したマッチリスト（あと3ステップ）",
    "次の画面：電気施工管理向けの<strong>求人概要</strong>を先にお見せします（全文は登録後にお届け · あと3ステップ）"
  ],
  [
  ...
  [
    ...
    "送信後：<strong>求人の概要</strong>を表示 → 全文は登録後にお届け（しつこい営業はしません）"
  ],
  [
