...
const requiredStrings = [
  ...
  ["thanks-page-context.js?v=25", "context v25 hero stats only"],
  ["thanks-section-visuals.js?v=2", "section visuals v2"],
  ["thanks-page.css?v=40", "css v40 hero balance"],
  ...
  ["thanks-hero-stats", "hero numeric gift stats id"],
...
const forbidden = [
  ...
  ["いまは<strong>日時だけ</strong>", "date-first hero copy"],
