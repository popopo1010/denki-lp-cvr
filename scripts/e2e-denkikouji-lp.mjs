...
async function main() {
  ...
  if (lpHtml.includes("cvr-boost-denkikouji.css?v20260713")) {
    pass("本番 CSS", "v20260713");
  } else if (lpHtml.match(/cvr-boost-denkikouji\.css\?v2026/)) {
    fail("本番 CSS", "v20260713 未反映（デプロイ待ち）");
  } else {
