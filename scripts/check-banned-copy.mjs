...
const BANNED = [
  ...
  // フォームの安心文・マイクロコピーに「お電話します」等の電話予告を入れない（2026-09-02 オーナー指示）。
  // 電話が来る期待値はCVRを下げる。期待値は「求人が（LINEで）見られる」に統一する。
  // FAQ・thanks-v2の電話ゲート説明は対象外（このパターンは3クラスの要素内だけを見る）。
  { pattern: /class="cvr-(?:step-reward|micro-copy|tel-reassurance)"(?:(?!<\/p>)[\s\S]){0,600}電話/, label: "電話予告（安心文/マイクロコピーに「電話」を入れない。期待値は求人閲覧）" },
