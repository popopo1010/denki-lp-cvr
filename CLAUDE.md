...
| `check-form-invariants.mjs` | クマの**移動配線**、スクロール/フォーカス5クラス、フォーム自己修復4クラス、ミラー一致（cvr-boost.js含む）、アプリ内ブラウザ余白(96pxのCSS **と** それを効かせる `body.lp-input-step` 付与の両方)、ステップの初期非表示、生まれ年範囲の一致、`form_step` の二重push禁止、予約先読みの範囲 |
