...
(function () {
  ...
  function applyHero(brand) {
    ...
    heroRoot.innerHTML =
      (name
        ? "<p class=\"t-hero__lead\">" + escHtml(name) + "さん、登録ありがとうございます</p>"
        : "<p class=\"t-hero__lead\">登録ありがとうございます</p>") +
      "<p class=\"t-hero__route\">まず下の<strong>概要</strong>をご覧ください。気になる方は<strong>日時</strong>を選ぶと全文へ。<strong>全文</strong>は10分のお電話後です。</p>" +
      HERO_OBJECTIONS;
  }
